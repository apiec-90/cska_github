...
CREATE INDEX "auth_group_permissions_group_id_permission_id_index" ON
...
CREATE INDEX "staff_staff_role_id_index" ON
    "staff"("staff_role_id");
ALTER TABLE
...
ALTER TABLE
    "parent" ADD CONSTRAINT "parent_phone_unique" UNIQUE("phone");
...
ALTER TABLE
    "athlete" ADD CONSTRAINT "athlete_phone_unique" UNIQUE("phone");
...
CREATE INDEX "training_group_trainer_id_index" ON
    "training_group"("trainer_id");
ALTER TABLE
...
ALTER TABLE
    "trainer" ADD CONSTRAINT "trainer_user_id_unique" UNIQUE("user_id");
ALTER TABLE
    "trainer" ADD CONSTRAINT "trainer_phone_unique" UNIQUE("phone");
...
ALTER TABLE
    "CustomStaffRole" ADD PRIMARY KEY("id");
ALTER TABLE
    "CustomStaffRole" ADD CONSTRAINT "customstaffrole_name_unique" UNIQUE("name");
CREATE TABLE "custom_staff_role_permissions"(
    "id" BIGINT NOT NULL,
    "auth_permission" BIGINT NOT NULL,
    "CustomStaffRole_id" BIGINT NOT NULL
);
CREATE INDEX "CustomStaffRole_id_auth_permission_index" ON
    "custom_staff_role_permissions"(
        "CustomStaffRole_id",
        "auth_permission"
    );
ALTER TABLE
    "custom_staff_role_permissions" ADD PRIMARY KEY("id");
ALTER TABLE
...
ALTER TABLE
    "custom_staff_role_permissions" ADD CONSTRAINT "custom_staff_role_permissions_customstaffrole_id_foreign" FOREIGN KEY("CustomStaffRole_id") REFERENCES "CustomStaffRole"("id");
ALTER TABLE
...
ALTER TABLE
    "training_group" ADD CONSTRAINT "training_group_trainer_id_foreign" FOREIGN KEY("trainer_id") REFERENCES "trainer"("id");
ALTER TABLE
    "training_group" ADD CONSTRAINT "training_group_archived_by_foreign" FOREIGN KEY("archived_by") REFERENCES "staff"("id");
ALTER TABLE
    "trainer" ADD CONSTRAINT "trainer_user_id_foreign" FOREIGN KEY("user_id") REFERENCES "auth_user"("id");
ALTER TABLE
...
ALTER TABLE
    "trainer" ADD CONSTRAINT "trainer_archived_by_foreign" FOREIGN KEY("archived_by") REFERENCES "staff"("id");
ALTER TABLE
...
ALTER TABLE
    "custom_staff_role_permissions" ADD CONSTRAINT "custom_staff_role_permissions_auth_permission_foreign" FOREIGN KEY("auth_permission") REFERENCES "auth_permission"("id");
ALTER TABLE
