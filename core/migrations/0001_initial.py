...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('role', models.CharField(blank=True, choices=[('trainer', 'Тренер'), ('parent', 'Родитель'), ('athlete', 'Спортсмен'), ('staff', 'Сотрудник')], max_length=20, null=True, verbose_name='Роль')),
                ('staff_role', models.CharField(blank=True, max_length=100, null=True, verbose_name='Подроль сотрудника')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('manager', 'Менеджер')], default='manager', max_length=50, verbose_name='Роль')),
                ('subrole', models.CharField(blank=True, max_length=100, null=True, verbose_name='Подроль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('phone', models.CharField(blank=True, default=None, max_length=255, null=True, unique=True, verbose_name='Телефон')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trainer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.trainer', verbose_name='Тренер')),
            ],
            options={
