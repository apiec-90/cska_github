...
class Command(BaseCommand):
    help = 'Создает 3 основные группы: Родители, Спортсмены, Сотрудники'

    def handle(self, *args, **options):
        self.stdout.write('Создаем 3 основные группы...')
        ...
        groups_config = {
            ...
            'Сотрудники': {
                'description': 'Сотрудники спортивной школы',
                'permissions': [
        ...
        self.stdout.write(
            self.style.SUCCESS('3 основные группы созданы успешно!')
        )
        self.stdout.write(
