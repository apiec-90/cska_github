...
from core.models import Staff, Parent, Athlete, Trainer, TrainingGroup, AthleteTrainingGroup, AthleteParent, CustomStaffRole
from datetime import date
import os

class Command(BaseCommand):
    help = 'Настройка новой структуры БД с группами и пользователями (без сигналов)'
    ...
    def handle(self, *args, **options):
        ...
        CustomStaffRole.objects.all().delete()
        ...
        # Создаем кастомную роль менеджера
        manager_role = CustomStaffRole.objects.create(
            name='manager',
            display_name='Менеджер',
            description='Менеджер спортивной школы'
        )
