...
from core.models import Staff, Parent, Athlete, TrainingGroup, Document, Payment

class Command(BaseCommand):
    help = 'Создает группы пользователей с ролями для Staff'

    def handle(self, *args, **options):
        self.stdout.write('Создаем группы пользователей с ролями...')
        ...
        groups_config = {
            ...
            'Помощники тренеров': {
                'description': 'Помощники тренеров',
                'permissions': [
                    'view_athlete',
                    'view_traininggroup',
                    'view_trainingsession', 'add_trainingsession',
                    'view_attendancerecord', 'add_attendancerecord', 'change_attendancerecord',
                    'view_document',
                ]
            },
            'Администраторы': {
                ...
                'permissions': [
                    'view_athlete', 'add_athlete', 'change_athlete', 'delete_athlete',
                    'view_parent', 'add_parent', 'change_parent', 'delete_parent',
                    'view_staff', 'add_staff', 'change_staff', 'delete_staff',
                    'view_traininggroup', 'add_traininggroup', 'change_traininggroup', 'delete_traininggroup',
                    'view_trainingsession', 'add_trainingsession', 'change_trainingsession', 'delete_trainingsession',
                    'view_attendancerecord', 'add_attendancerecord', 'change_attendancerecord', 'delete_attendancerecord',
            ...
            'Менеджеры': {
                ...
                'permissions': [
                    'view_athlete', 'add_athlete', 'change_athlete',
                    'view_parent', 'add_parent', 'change_parent',
                    'view_traininggroup', 'add_traininggroup', 'change_traininggroup',
                    'view_payment', 'add_payment', 'change_payment',
                    'view_document', 'add_document', 'change_document',
                ]
        ...
        self.stdout.write(
            self.style.SUCCESS('Группы с ролями созданы успешно!')
        )
